package ouvintes.AdicionarCreditos;
...
public class OuvinteBotaoComprar implements ActionListener {
	...
	public OuvinteBotaoComprar(JFrame tela, JFormattedTextField campoCreditos, Mototaxista infoMototaxista,
			CentralDeInformacoes centralD) {
		telaAtual = tela;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (!quantidadeCreditos.getText().isBlank()) {
			...
			JOptionPane.showConfirmDialog(null, "Digite um valor", "ALERTA", JOptionPane.DEFAULT_OPTION,
