...
import exceções.CorridaNaoAdicionadaException;
import sistemas.Corridas.Avaliacao;
import sistemas.Corridas.Corrida;
import sistemas.Corridas.ValorCorrida;
...
public class Passageiro extends Usuario {
	...
	public void cadastrarCorrida(String enderecoP, String enderecoD, float distancia, boolean paraAgora,
			LocalDateTime data, CentralDeInformacoes central) throws CorridaNaoAdicionadaException {
		boolean deuCerto = central.adicionarCorrida(
				new Corrida(enderecoP, enderecoD, distancia, paraAgora, data, this, new ValorCorrida(1, data)));
		if (!deuCerto)
			throw new CorridaNaoAdicionadaException();
	}

	public void avaliarCorrida(Corrida cor, Mototaxista mot, float nota, String comentario,
